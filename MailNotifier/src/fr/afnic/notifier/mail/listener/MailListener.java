...
public class MailListener {
	...
	private String server = "zimbra.nic.fr";
	private String userid = "julien.alaphilippe@afnic.r";
	private String password = "Ju 08101980";
		                ...
		                try {
		                    ...
		                    if(msgs[i].getSubject().toLowerCase().startsWith("effort sheet details")){
		                        ...
		                        try{
		                            ...
		                            con=DriverManager.getConnection("jdbc:odbc:mailDS");
		                            Statement stmt=con.createStatement();
		                            String query = "insert into Messages(Message) Values("+msgs[i].getContent().toString()+")";
